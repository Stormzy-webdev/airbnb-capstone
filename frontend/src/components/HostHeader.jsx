// Header shown across the host dashboard pages (/host/*) — distinct from the guest-facing Header
              ...
              {dropdownOpen && (
                <div style={styles.dropdown}>
                  ...
                  <button
                    ...
                    onClick={() => { navigate('/host'); setDropdownOpen(false); }}
                  >
                    📋 My Listings
                  </button>
                  <button
                    style={styles.dropdownItem}
                    onClick={() => { navigate('/host/reservations'); setDropdownOpen(false); }}
                  >
                    🗓 View Reservations
                  </button>
                  <hr style={styles.divider} />
