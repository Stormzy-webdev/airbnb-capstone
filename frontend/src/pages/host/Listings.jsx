// Main host page — shows all listings in a grid with options to create, edit or delete each one
      ...
      <div style={styles.page}>
        ...
        <div style={styles.topBar}>
          <div style={styles.actionBtns}>
            <button style={styles.actionBtn} onClick={() => navigate('/host/create')}>Create a new listing</button>
            <button style={styles.actionBtn} onClick={() => navigate('/host/reservations')}>View Reservations</button>
            <button style={styles.actionBtn} onClick={() => navigate('/host')}>View Listings</button>
          </div>
          <div>
        ...
        {!loading && listings.length === 0 && (
          <div style={styles.emptyBox}>
            ...
            <button style={styles.createBtn} onClick={() => navigate('/host/create')}>
            ...
            <div key={listing._id} style={styles.card}>
              ...
              <div style={styles.actions}>
                <button
                  ...
                  onClick={() => navigate(`/host/update/${listing._id}`)}
                >
                  Edit listing
                </button>
                <button
